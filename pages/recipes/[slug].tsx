  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      <div className="flex items-center gap-2 px-[122px] py-6">
        ...
        <span className="text-xs font-medium text-[#595959] opacity-60">{recipe.title}</span>
      </div>

      {/* Recipe Header */}
      <div className="px-[122px] py-12">
        <div className="flex flex-col items-center gap-7 text-center">
          <span className="px-5 py-[3px] bg-[#c06654] text-[#f6f6f6] text-lg font-semibold rounded-[80px]">
            {recipe.categories[0]?.title}
          </span>
          <h1 className="text-[44px] font-semibold text-[#354439]">{recipe.title}</h1>
          <div className="flex items-center gap-6 text-lg text-[#354439]">
      ...
      {/* Recipe Content */}
      <div className="px-[122px] py-16">
        <div className="grid grid-cols-12 gap-12">
          {/* Left Column - Ingredients */}
          <div className="col-span-4">
            <div className="sticky top-8">
              <h2 className="text-2xl font-semibold text-[#354439] mb-8">Ingredients</h2>
              <ul className="space-y-4">
                {recipe.ingredients.map((ingredient) => (
                  <li key={ingredient._key} className="flex items-start gap-3">
                    ...
                    <span className="text-lg text-[#354439]">
          ...
          <div className="col-span-8">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-2xl font-semibold text-[#354439] mb-8">Instructions</h2>
              <PortableText value={recipe.instructions} />

              {recipe.tips && recipe.tips.length > 0 && (
                <>
                  <h2 className="text-2xl font-semibold text-[#354439] mt-12 mb-8">Tips</h2>
              ...
              {recipe.nutritionalInfo && (
                <div className="mt-12">
                  <h2 className="text-2xl font-semibold text-[#354439] mb-8">Nutritional Information</h2>
                  <div className="grid grid-cols-4 gap-6">
                    <div className="bg-[#f9f9f9] p-6">
                      <h3 className="text-lg font-semibold text-[#354439] mb-2">Calories</h3>
                      <p className="text-xl text-[#354439]">{recipe.nutritionalInfo.calories} kcal</p>
                    </div>
                    <div className="bg-[#f9f9f9] p-6">
                      <h3 className="text-lg font-semibold text-[#354439] mb-2">Protein</h3>
                      <p className="text-xl text-[#354439]">{recipe.nutritionalInfo.protein}g</p>
                    </div>
                    <div className="bg-[#f9f9f9] p-6">
                      <h3 className="text-lg font-semibold text-[#354439] mb-2">Carbs</h3>
                      <p className="text-xl text-[#354439]">{recipe.nutritionalInfo.carbs}g</p>
                    </div>
                    <div className="bg-[#f9f9f9] p-6">
                      <h3 className="text-lg font-semibold text-[#354439] mb-2">Fat</h3>
                      <p className="text-xl text-[#354439]">{recipe.nutritionalInfo.fat}g</p>
                    </div>
                  </div>
                </div>
              )}
      ...
      {/* Newsletter Section */}
      <div className="mx-[122px] my-20 bg-[#f9f9f9] h-[200px] flex items-center justify-between px-10">
        <div>
